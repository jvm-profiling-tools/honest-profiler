...
import static com.insightfullogic.honest_profiler.core.FlatGenerator.assertContains;
...
public class DescendantFlatAggregatorTest
{
    ...
    {
        Flat flat = get(LogEventFactory::applyScenario01, tg, fg, T_01, F_01);
    ...
    {
        Flat flat = get(LogEventFactory::applyScenario02, tg, fg, T_01, F_05, F_04, F_03);
    ...
    {
        Flat flat = get(LogEventFactory::applyScenario06, tg, fg, T_01, F_05, F_04, F_03);
    ...
    private Flat get(Consumer<TreeGenerator> scenario, ThreadGrouping tg, FrameGrouping fg,
